...
export default function TradeEntry({ onSubmit }) {
  ...
  const handleQuickEntry = () => {
    ...
    onSubmit(trade);
    setFormData({ symbol: '', market_type: 'stocks', type: 'long', entry_price: '', quantity: '', timeframe: '1d' });
  };
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className={formData.type === 'long' ? 'bg-emerald-600 hover:bg-emerald-700 flex-1' : 'border-slate-700 flex-1'}
          >
          ...
          <Button
            ...
            className={formData.type === 'short' ? 'bg-rose-600 hover:bg-rose-700 flex-1' : 'border-slate-700 flex-1'}
          >
