  ...
  return (
    <div className="bg-shell-card rounded-xl p-6 border border-shell-glow">
      ...
      <div className="mb-6 space-y-3">
        ...
        <textarea
          placeholder={tradeId ? "Why you exited, what you felt..." : "Market observations, strategy thoughts..."}
          value={content}
      ...
      <div className="space-y-3 max-h-96 overflow-y-auto">
        {notes.length === 0 ? (
          ...
          notes.map(note => (
            <div key={note.id} className="bg-shell-accent p-4 rounded border border-shell-glow hover:border-shell-yellow transition">
