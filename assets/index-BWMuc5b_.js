...
function J1() {
  ...
  function F(o, j, W) {
    var hl = null;
    if ((W !== void 0 && (hl = '' + W), j.key !== void 0 && (hl = '' + j.key), 'key' in j)) {
      W = {};
      for (var Rl in j) Rl !== 'key' && (W[Rl] = j[Rl]);
    } else W = j;
    return (j = W.ref), { $$typeof: U, type: o, key: hl, ref: j !== void 0 ? j : null, props: W };
  }
...
function W1() {
  ...
  function At(y, E, O) {
    var M = O.ref;
    return { $$typeof: U, type: y, key: E, ref: M !== void 0 ? M : null, props: O };
  }
  function Qu(y, E) {
    ...
    (C.createElement = function (y, E, O) {
      ...
      if (E != null)
        for (M in (E.key !== void 0 && (X = '' + E.key), E))
          Xl.call(E, M) && M !== 'key' && M !== '__self' && M !== '__source' && (Y[M] = E[M]);
    ...
    (C.startTransition = function (y) {
      ...
      try {
        var M = y(),
          Y = L.S;
        Y !== null && Y(O, M),
          typeof M == 'object' && M !== null && typeof M.then == 'function' && M.then(jl, tl);
      } catch (X) {
        tl(X);
      } finally {
      ...
      (function (U) {
        ...
        function ft(b) {
          for (var _ = F(A); _ !== null; ) {
            ...
            else if (_.startTime <= b) o(A), (_.sortIndex = _.expirationTime), ml(N, _);
            else break;
            _ = F(A);
          }
        }
          ...
          (U.unstable_scheduleCallback = function (b, _, q) {
            ...
            return (
              ...
              q > tl
                ...
                : ((b.sortIndex = nl), ml(N, b), Gl || Wl || ((Gl = !0), jl || ((jl = !0), Ql()))),
              b
            );
          }),
...
function P1() {
  ...
  function Cl(l, t) {
    switch ((O(X, t), O(Y, l), O(M, null), t.nodeType)) {
      ...
      case 11:
        ...
        break;
      default:
        if (((l = t.tagName), (t = t.namespaceURI))) (t = Yy(t)), (l = By(t, l));
        else
          switch (l) {
            case 'svg':
              l = 1;
  ...
  function Te(l) {
    Y.current === l && (E(M), E(Y)), I.current === l && (E(I), (he._currentValue = q));
  }
  var Xn, mi;
  function Eu(l) {
    if (Xn === void 0)
...
` +
  ...
  var xn = Object.prototype.hasOwnProperty,
    ...
    kl = null;
  function $t(l) {
    if ((typeof Um == 'function' && Hm(l), kl && typeof kl.setStrictMode == 'function'))
      try {
  ...
  function us(l) {
    ...
    return t.getModifierState ? t.getModifierState(l) : (l = ts[l]) ? !!t[l] : !1;
  }
  function vf() {
    return us;
  }
  ...
  function Qe(l, t, u, a, e, n) {
    ...
    if (((a = l), typeof l == 'function')) Tf(l) && (f = 1);
      ...
      f = C1(l, u, M.current) ? 26 : l === 'html' || l === 'head' || l === 'body' ? 27 : 5;
    else
      l: switch (l) {
        case At:
  ...
  function o0(l, t) {
    (mt[st++] = Ot), (mt[st++] = rt), (mt[st++] = It), (Ot = t.id), (rt = t.overflow), (It = l);
  }
  var Ml = null,
    cl = null,
    K = !1,
  ...
  b.S = function (l, t) {
    (ay = Fl()),
      typeof t == 'object' && t !== null && typeof t.then == 'function' && qs(l, t),
      T0 !== null && T0(l, t);
  };
  var Ru = y(null);
  function Rf() {
  ...
  function M0(l) {
    ...
    function T(m, v, s) {
      ...
      if (typeof v == 'object' && v !== null) {
        ...
        if (gt(v) || Ql(v)) return (v = Uu(v, m.mode, s, null)), (v.return = m), v;
    ...
    function r(m, v, s, z) {
      for (var H = null, J = null, D = v, G = (v = 0), V = null; D !== null && G < s.length; G++) {
      ...
      if (D === null) {
        for (; G < s.length; G++)
          (D = T(m, s[G], z)),
            D !== null && ((v = n(D, v, G)), J === null ? (H = D) : (J.sibling = D), (J = D));
        return K && Ct(m, G), H;
      }
    ...
    function p(m, v, s, z) {
      ...
      if (D === null) {
        for (; !w.done; G++, w = s.next())
          (w = T(m, w.value, z)),
            w !== null && ((v = n(w, v, G)), J === null ? (H = w) : (J.sibling = w), (J = w));
        return K && Ct(m, G), H;
      }
  ...
  function R0(l) {
    ...
    if (((Gt = 0), (zl = ul = B = null), (ke = !1), ($a = 0), (ma = null), t)) throw Error(o(300));
  ...
  function un(l, t, u, a) {
    var e = Yl();
    (B.flags |= l), (e.memoizedState = sa(1 | t, { destroy: void 0 }, u, a === void 0 ? null : a));
  }
  function an(l, t, u, a) {
    var e = gl();
    a = a === void 0 ? null : a;
  ...
  function xs(l, t, u) {
    ...
    (u = {
      ...
      en(l) ? sv(t, u) : ((u = zf(l, t, u, a)), u !== null && (wl(u, l, a), dv(u, t, a)));
  }
  function mv(l, t, u) {
    var a = nt();
    ka(l, t, u, a);
  ...
  var hv = {
      ...
      useTransition: function () {
        var l = $f(!1);
        return (l = fv.bind(null, B, l.queue, !0, !1)), (Yl().memoizedState = l), [!1, l];
      },
    ...
    switch (((t.lanes = 0), t.tag)) {
      ...
      case 5:
        return (
          ...
          t.memoizedState !== null && ((e = xf(l, t, Bs, null, null, u)), (he._currentValue = e)),
          cn(l, t),
          Ul(l, t, a, u),
          t.child
        );
  ...
  function Js(l, t, u) {
    ...
    switch ((Of(t), t.tag)) {
      ...
      case 26:
        ...
        return (
          l === null
            ? (Qt(t), n !== null ? (il(t), Gv(t, n)) : (il(t), Sc(t, e, null, a, u)))
            : n
            ? n !== l.memoizedState
              ? (Qt(t), il(t), Gv(t, n))
      ...
      case 27:
        if ((Te(t), (u = X.current), (e = t.type), l !== null && t.stateNode != null))
          ...
          (l = M.current), aa(t) ? S0(t) : ((l = Ly(e, a, u)), (t.stateNode = l), Qt(t));
        }
        return il(t), null;
      case 5:
  ...
  function $s(l) {
    switch (l.tag) {
      ...
      case 22:
        return (
          (l = l.stateNode), (t = l._retryCache), t === null && (t = l._retryCache = new Lv()), t
        );
      default:
    ...
    for (l = l.child; l !== null; ) {
      ...
      switch (t.tag) {
        ...
        case 1:
          Mt(t, t.return);
          var u = t.stateNode;
          typeof u.componentWillUnmount == 'function' && Qv(t, t.return, u), ju(t);
          break;
        case 27:
          me(t.stateNode);
        case 26:
  ...
  function Pv(l, t, u) {
    switch (l.tag) {
      case 26:
        ha(l, t, u),
          l.flags & ee && l.memoizedState !== null && Y1(u, zt, l.memoizedState, l.memoizedProps);
        break;
      case 5:
        ha(l, t, u);
        break;
  ...
  function wl(l, t, u) {
    ((l === fl && (P === 2 || P === 9)) || l.cancelPendingCommit !== null) &&
      ...
      Ua(l, u),
      (($ & 2) === 0 || l !== fl) &&
        (l === fl && (($ & 2) === 0 && (Xu |= u), dl === 4 && su(l, x, et, !1)), Dt(l));
  }
  function fy(l, t, u) {
  ...
  function bn() {
    (dl = 4),
      ...
      ((vu & 134217727) === 0 && (Xu & 134217727) === 0) || fl === null || su(fl, x, et, !1);
  }
  function Nc(l, t, u) {
    var a = $;
    $ |= 2;
  ...
  function Ty() {
    ...
    try {
      ...
      var n = mu,
        f = Jt;
      if (((Al = 0), (ga = mu = null), (Jt = 0), ($ & 6) !== 0)) throw Error(o(331));
      var c = $;
      if (
        (($ |= 4),
        ty(n.current),
  ...
  function Oy(l, t) {
    ...
    if ((u & 3) === 0 || Da(l, u)) {
      ...
      return (
        (a = ry.bind(null, l)), (u = Vn(u, a)), (l.callbackPriority = t), (l.callbackNode = u), t
      );
    }
    ...
    Yi(function () {
      ...
      if ((t & 7) === 0) {
          ...
          if (
            ...
            if (
              ...
              (l === 'pointerout' || l === 'pointerover') &&
                ((p = Qi), (z = 'onPointerLeave'), (m = 'onPointerEnter'), (v = 'pointer')),
              (el = S == null ? h : Na(S)),
              (s = r == null ? h : Na(r)),
        ...
        switch (((D = d ? Na(d) : window), l)) {
          case 'focusin':
            (Ji(D) || D.contentEditable === 'true') && ((ku = D), (hf = d), (Xa = null));
            break;
          case 'focusout':
            Xa = hf = ku = null;
            break;
...
`
  ...
  function Fy(l, t, u) {
    ...
    for (a.set(l, null), u = u.getElementsByTagName(l), e = 0; e < u.length; e++) {
      var n = u[e];
      if (
        !(n[Ha] || n[rl] || (l === 'link' && n.getAttribute('rel') === 'stylesheet')) &&
        n.namespaceURI !== 'http://www.w3.org/2000/svg'
      ) {
  ...
  function pn(l, t) {
    (l.stylesheets = null),
      l.unsuspend !== null &&
        (l.count++, (Nn = new Map()), t.forEach(G1, l), (Nn = null), Hn.call(l));
  }
  function G1(l, t) {
  ...
  function Yn(l, t) {
    l.blockedOn === t &&
      ((l.blockedOn = null),
      ui || ((ui = !0), U.unstable_scheduleCallback(U.unstable_NormalPriority, V1)));
  }
  var Bn = null;
  function vm(l) {
    Bn !== l &&
  ...
  return Bl.jsxs(Bl.Fragment, {
    children: [
      Bl.jsxs('div', {
        children: [
          Bl.jsx('a', {
            href: 'https://vite.dev',
            target: '_blank',
            children: Bl.jsx('img', { src: ad, className: 'logo', alt: 'Vite logo' }),
          }),
          Bl.jsx('a', {
            href: 'https://react.dev',
            target: '_blank',
            children: Bl.jsx('img', { src: ud, className: 'logo react', alt: 'React logo' }),
          }),
        ],
      }),
      ...
      Bl.jsxs('div', {
        className: 'card',
        children: [
          Bl.jsxs('button', { onClick: () => ml((F) => F + 1), children: ['count is ', U] }),
          Bl.jsxs('p', {
            children: [
              'Edit ',
              Bl.jsx('code', { children: 'src/App.tsx' }),
